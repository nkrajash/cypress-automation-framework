describe("Test contact-us form via WebDriverUni", () => {
    ...
    beforeEach( function() {
        ...
        cy.visit("/") //click on remote URL using the env variable baseUrl in cypress.json
    ...
    it("should be able to submit a successful submission via contact-us form ", () => {
        ...
        cy.webdriverUni_ContactForm_Submission(Cypress.env("first_name"), Cypress.env("last_name"), data.email, "How can I learn Cypress", "h1","Thank You for your Message!")
    ...
    it("should not be able to submit a successful submission via contact-us form as all fields are required", () => {
        ...
        cy.webdriverUni_ContactForm_Submission(Cypress.env("first_name"), Cypress.env("last_name"), " ", "How can I learn Cypress" ,"body","Error: Invalid email address")
